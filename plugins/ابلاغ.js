...
if (!text) throw `*[❗تحذير❗] ادخل مشكلتك و بلاغك*\n\n*مثال:*\n*${usedPrefix + command} مرحباً عزيزي العقرب اليوتيوبر ${usedPrefix}كيف اخبارك*`
...
conn.reply('201143638030@s.whatsapp.net', m.quoted ? teks + m.quoted.text : teks, null, { contextInfo: { mentionedJid: [m.sender] }})
conn.reply('@s.whatsapp.net', m.quoted ? teks + m.quoted.text : teks, null, { contextInfo: { mentionedJid: [m.sender] }})
m.reply(`*[ 🌚❤ ] تم إبلاغ المطور و انشاء الله يكون ف خدمتك في أسرع وقت 🇵🇸🔥*`)
}
