...
const defaultMenu = {
  before: `
> *اهلا بيك في بوت العقرب اليوتيوبر منور يا قلب اخوك ♥✨*
...
    let listCmd =  `
> اهلا بيك في بوت واتساب العقرب اليوتيوبر ♥✨
...
    if (teks == '404') {
        return conn.sendButtonImg(m.chat, 'https://atom.bio/elakrabelyotyobr', "", listCmd.trim(), " ", buttons, m, { 
            contextInfo: {
			...
			m.chat,
			{
				...
				contextInfo: {
					...
					externalAdReply: {
						...
						mediaType: 1,
						thumbnailUrl: `https://atom.bio/elakrabelyotyobr`,
						mediaUrl: ``,
						sourceUrl: "https://www.youtube.com/@Elakrab",
					},
				},
			},
			{ quoted: m },
