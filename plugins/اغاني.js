...
⬡ S: ${ago}
⬡ E: ${url}
╰────────⬣`, author.trim(), await( await conn.getFile(thumbnail)).data, ['📽 VIDEO', `${usedPrefix}getvid ${url} 360`], false, { quoted: m, 'document': { 'url':'https://wa.me/+201143638030' },
...
mediaType:  2,
mediaUrl: `${url}`,
title: `ELAKRAB ELYOTUBER ♥...`,
body:author,
sourceUrl: 'http://wa.me/+201143638030', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
